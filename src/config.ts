  ...
  projects: [
    {
      ...
      subtitle: '',
      topics:
        'PRM, Approximate Cell Decomposition, Multipoint Dubins, Orienteering, Polygon Inflation, Shortcutting, ROS, RViz, Gazebo, Loco Nav, Simulation, Agile X LIMO, Victim Rescue',
      description:
        'Motion planning project on an Agile X LIMO. Explored both Combinatorial and Sampling Based planning to solve the Victim Rescue problem in a controlled environment. Explored different techniques to design the full planning pipeline that includes reading the map and applying obstacle inflation, building the roadmap with a sampling-based or combinatorial approach, computing shortest paths, the orienteering problem and generating the final Dubins trajectory.',
    ...
    },
    {
      ...
      topics:
        'Reinforcement Learning, PPO Algorithm, REINFORCE algorithm, Unicycle Kinematics, Trajectory Tracking, Navigation, Obstacle Avoidance, LIDAR',
      description:
        'Final and most important assignment of the Optimization and Learning for Robot Control course. Explored different reinforcement learning techniques applied to an unicycle robot. Implemented trajectory tracking using the REINFORCE algorithm and a the the PPO (Proximal Policy Optimization) algorithm to solve a full navigation problem in an obstacle-filled environment (shown in the preview).',
    ...
    },
    {
      ...
      description:
        'First assignment Optimization and Learning for Robot Control course.. Developed a reactive control framework using Task Space Inverse Dynamics (TSID) to enable a humanoid robot to track complex trajectories and perform walking motions while maintaining dynamic balance.',
    ...
    },
    {
      ...
      description:
        'Second assignment of the Optimization and Learning for Robot Control course, focused on Optimal Control. Applied both trajectory tracking and path tracking techniques optimization techniques to a UR5 industrial robotic arm.',
    ...
    },
    {
      ...
      description:
        'Task planning project set in an Interplanetary Museum Vault, implemented different planning techniques such as classical planning, temporal planning, or hierarchical task networks. Compared the performance of different solvers to discover their peculiarities.',
    ...
    },
    {
      ...
      topics:
        'Embedded C, MSP-432 (ARM Cortex M4), Bluetooth Control, LCD Display, Stepper Motors, Servo, Finite State Machine, 3D Printing, 3D Modelling',
      description:
        'Embedded software project consisting of the creation and programming of a claw machine. We built everything from scratch, starting with designing the aluminum frame, 3D printing some components, designing the electronics, and finally programming the entire software in C. This project was presented at Fablab Trento during ICT Days 2024.',
    ...
    },
    {
      ...
      topics:
        'C++, Open CV, MIDI Protocol, Ableton Link, Multithreading, Real-time Data Processing, Low-latency Visualization',
      description:
        'This custom VJ software was developed to meet the specific needs of live events, prioritizing simplicity and real-time performance. It enables seamless overlaying of foreground logos onto dynamic background loops, with integrated effects like strobe and beat-synced motion. By leveraging Ableton Link, Visual-Hive synchronizes with DJ software to extract BPM and song structure, ensuring perfectly timed visual transitions. While currently CLI-based, development is ongoing to integrate full MIDI mapping and a dedicated GUI.',
  ...
  education: [
    {
      ...
      thesisTitle: '/',
      skills:
        'Motion Planning | Task Planning | Deep Learning | Reinforcement Learning | Robotic Perception | Computer Vision | Natural Language Understanding',
      thesisPdf: '',
      github: '',
    },
    {
      ...
      skills:
        'C | C++ | Python | Rust | Embedded C | Embedded Applications | Linux Shell | Git | Algorithms & Data Structures | Operating Systems | 3D Printing | Basic 3D Design | Basic Electronic',
    ...
    },
    {
      ...
      skills:
        'C | C++ | Java | C# | Full Stack Web Development | SQL | JavaScript | Games Development | Networking | Git',
      thesisPdf: '',
